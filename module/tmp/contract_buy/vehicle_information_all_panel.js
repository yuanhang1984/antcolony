function vehicle_information_open_info_func(obj) {
  ...
  //船板单
  report_boat_ullage = get_vehicle_object_list(report_boat_ullage_list, vehicle_information_uuid); 
  report_boat_ullage.report_boat_ullage_content();
  ...
  // 清空原始数据
  report_boat_ullage.report_boat_ullage_clear_raw_data();
  // 服务器数据
  report_boat_ullage.report_boat_ullage_server_data_cover();
  // 加载数据
  report_boat_ullage.report_boat_ullage_fill_variable_data();
